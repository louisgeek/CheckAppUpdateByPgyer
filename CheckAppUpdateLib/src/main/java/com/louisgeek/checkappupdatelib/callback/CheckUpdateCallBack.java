...
public abstract class CheckUpdateCallBack {
    public  abstract void OnSuccess(String result,int statusCode,FirImBean firImBean);

    public  abstract void OnSuccessNotifyUI(String result,int statusCode,FirImBean firImBean);
